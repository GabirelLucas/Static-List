...
const SortableItem: React.FC<SortableItemProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`flex items-center bg-zinc-950 p-4 rounded-2 gap-4 select-none border border-transparent 
        hover:border-zinc-400 hover:opacity-80 cursor-grab active:cursor-grabbing
